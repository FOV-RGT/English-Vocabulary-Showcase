---
theme: seriph
background: https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=1920
title: English Vocabulary Showcase
info: |
  ## 大学英语单词学习
  12个高级词汇展示与学习
class: text-center
...
<div class="text-2xl mt-8 mb-4">
  <span class="text-blue-400">Unit 6 Passage A</span> · 高级词汇学习
</div>

<div class="text-lg opacity-80">
  12 Advanced Words for College English
</div>

<div class="abs-br m-6 flex gap-2">
  <button @click="$slidev.nav.next" class="px-4 py-2 rounded bg-blue-500 hover:bg-blue-600">
    开始学习 →
  </button>
</div>
...
<div class="text-xl text-gray-500 dark:text-gray-400 mb-12">
本次学习包含以下12个高级词汇
</div>
...
<div>
<div class="text-blue-500 font-bold text-2xl mb-2">1. Opus</div>
<div class="text-gray-600 dark:text-gray-400">作品</div>
</div>

<div>
<div class="text-green-500 font-bold text-2xl mb-2">2. Equilibrium</div>
<div class="text-gray-600 dark:text-gray-400">平衡</div>
</div>

<div>
<div class="text-red-500 font-bold text-2xl mb-2">3. Staggering</div>
<div class="text-gray-600 dark:text-gray-400">令人震惊的</div>
</div>

<div>
<div class="text-purple-500 font-bold text-2xl mb-2">4. Armamentarium</div>
<div class="text-gray-600 dark:text-gray-400">全套设备</div>
</div>

<div>
<div class="text-cyan-500 font-bold text-2xl mb-2">5. Atom</div>
<div class="text-gray-600 dark:text-gray-400">原子</div>
</div>

<div>
<div class="text-teal-500 font-bold text-2xl mb-2">6. Circadian</div>
<div class="text-gray-600 dark:text-gray-400">昼夜节律的</div>
</div>

<div>
<div class="text-pink-500 font-bold text-2xl mb-2">7. Vibration</div>
<div class="text-gray-600 dark:text-gray-400">振动</div>
</div>

<div>
<div class="text-orange-500 font-bold text-2xl mb-2">8. Bladder</div>
<div class="text-gray-600 dark:text-gray-400">膀胱</div>
</div>

<div>
<div class="text-lime-500 font-bold text-2xl mb-2">9. Formula</div>
<div class="text-gray-600 dark:text-gray-400">配方</div>
</div>

<div>
<div class="text-indigo-500 font-bold text-2xl mb-2">10. Yardstick</div>
<div class="text-gray-600 dark:text-gray-400">衡量标准</div>
</div>

<div>
<div class="text-rose-500 font-bold text-2xl mb-2">11. Alkaloid</div>
<div class="text-gray-600 dark:text-gray-400">生物碱</div>
</div>

<div>
<div class="text-emerald-500 font-bold text-2xl mb-2">12. Therapeutic</div>
<div class="text-gray-600 dark:text-gray-400">治疗的</div>
</div>
...
<div class="text-8xl font-bold mt-8 mb-4">
  Opus
</div>
...
<div v-click class="p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-xl mb-6 border-l-4 border-blue-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.blue="1" class="text-gray-800 dark:text-gray-200">（尤指古典音乐的）作品；（编号的）音乐作品</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
    <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˈoʊpəs/</span></div>
    <button @click="speak('opus', 'en-US')" class="mr-2 px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-sm rounded">
        🇺🇸 美式
    </button>
    <button @click="speak('opus', 'en-GB')" class="px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-sm rounded">
        🇬🇧 英式
  </button>
</div>
</v-click>
...
<div v-click class="p-4 bg-gradient-to-r from-green-50 to-emerald-100 dark:from-green-900 dark:to-emerald-800 rounded-xl mb-6 border-l-4 border-green-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.red="1" class="text-gray-800 dark:text-gray-200">平衡，均衡；（心理上的）平静；稳定状态</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-green-50 dark:bg-green-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˌiːkwɪˈlɪbriəm/</span></div>
  <button @click="speak('equilibrium', 'en-US')" class="mr-2 px-3 py-1 bg-green-500 hover:bg-green-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('equilibrium', 'en-GB')" class="px-3 py-1 bg-green-500 hover:bg-green-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
<div v-click class="p-4 bg-gradient-to-r from-red-50 to-rose-100 dark:from-red-900 dark:to-rose-800 rounded-xl mb-6 border-l-4 border-red-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.yellow="1" class="text-gray-800 dark:text-gray-200">令人震惊的；难以置信的；惊人的；蹒跚的</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-red-50 dark:bg-red-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˈstæɡərɪŋ/</span></div>
  <button @click="speak('staggering', 'en-US')" class="mr-2 px-3 py-1 bg-red-500 hover:bg-red-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('staggering', 'en-GB')" class="px-3 py-1 bg-red-500 hover:bg-red-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
<div class="text-7xl font-bold mt-8 mb-4">
  Armamentarium
</div>
...
# Armamentarium
<div class="text-base text-gray-500 mb-4 leading-relaxed">
  <div><span class="text-gray-600 dark:text-gray-400">🇺🇸</span> /ˌɑːrməˈmentəriəm/</div>
...
<div v-click class="p-4 bg-gradient-to-r from-purple-50 to-violet-100 dark:from-purple-900 dark:to-violet-800 rounded-xl mb-6 border-l-4 border-purple-500">
  ...
  <div class="text-base">
    ...
    <span v-mark.underline.green="1" class="text-gray-800 dark:text-gray-200">（医生的）全套设备；（解决问题的）全部手段/资源；武器装备</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-purple-50 dark:bg-purple-900 rounded-lg">
  <div class="text-sm font-bold mb-3">🔊 发音</div>
  <div class="mb-2">
    <button @click="speak('armamentarium', 'en-US')" class="mr-2 px-3 py-1 bg-purple-500 hover:bg-purple-600 text-white text-sm rounded">
      🇺🇸 美式
    </button>
    <span class="text-xs text-gray-500">/ˌɑːrməˈmentəriəm/</span>
  </div>
  <div>
    <button @click="speak('armamentarium', 'en-GB')" class="mr-2 px-3 py-1 bg-purple-500 hover:bg-purple-600 text-white text-sm rounded">
      🇬🇧 英式
    </button>
...
<div v-click class="p-4 bg-gradient-to-r from-cyan-50 to-sky-100 dark:from-cyan-900 dark:to-sky-800 rounded-xl mb-6 border-l-4 border-cyan-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.yellow="1" class="text-gray-800 dark:text-gray-200">原子；微粒；微量</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-cyan-50 dark:bg-cyan-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˈætəm/</span></div>
  <button @click="speak('atom', 'en-US')" class="mr-2 px-3 py-1 bg-cyan-500 hover:bg-cyan-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('atom', 'en-GB')" class="px-3 py-1 bg-cyan-500 hover:bg-cyan-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
# Circadian
<div class="text-lg text-gray-500 mb-4 leading-relaxed flex space-x-4">
  <div><span class="text-gray-600 dark:text-gray-400">🇺🇸</span> /sərˈkeɪdiən/</div>
...
<div v-click class="p-4 bg-gradient-to-r from-teal-50 to-cyan-100 dark:from-teal-900 dark:to-cyan-800 rounded-xl mb-6 border-l-4 border-teal-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.red="1" class="text-gray-800 dark:text-gray-200">昼夜节律的；生理节奏的（通常指24小时周期）</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-teal-50 dark:bg-teal-900 rounded-lg">
  <div class="text-sm font-bold mb-3">🔊 发音</div>
  <div class="mb-2">
    <button @click="speak('circadian', 'en-US')" class="mr-2 px-3 py-1 bg-teal-500 hover:bg-teal-600 text-white text-sm rounded">
      🇺🇸 美式
    </button>
    <span class="text-xs text-gray-500">/sərˈkeɪdiən/</span>
  </div>
  <div>
    <button @click="speak('circadian', 'en-GB')" class="mr-2 px-3 py-1 bg-teal-500 hover:bg-teal-600 text-white text-sm rounded">
      🇬🇧 英式
    </button>
...
<div class="text-2xl text-pink-400">
  n. 振动；震动
</div>
...
<div v-click class="p-4 bg-gradient-to-r from-pink-50 to-rose-100 dark:from-pink-900 dark:to-rose-800 rounded-xl mb-6 border-l-4 border-pink-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.blue="1" class="text-gray-800 dark:text-gray-200">振动；颤动；（感情的）共鸣；气氛</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-pink-50 dark:bg-pink-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/vaɪˈbreɪʃən/</span></div>
  <button @click="speak('vibration', 'en-US')" class="mr-2 px-3 py-1 bg-pink-500 hover:bg-pink-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('vibration', 'en-GB')" class="px-3 py-1 bg-pink-500 hover:bg-pink-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
<div v-click class="p-4 bg-gradient-to-r from-amber-50 to-orange-100 dark:from-amber-900 dark:to-orange-800 rounded-xl mb-6 border-l-4 border-amber-500">
  ...
  <div class="text-base">
    ...
    <span v-mark.underline.green="1" class="text-gray-800 dark:text-gray-200">膀胱；囊状物；气囊</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-amber-50 dark:bg-amber-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˈblædər/</span></div>
  <button @click="speak('bladder', 'en-US')" class="mr-2 px-3 py-1 bg-amber-500 hover:bg-amber-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('bladder', 'en-GB')" class="px-3 py-1 bg-amber-500 hover:bg-amber-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
<div class="text-2xl text-lime-400">
  n. 配方；处方
</div>
...
# Formula
<div class="text-lg text-gray-500 mb-4 leading-relaxed flex space-x-4">
  <div><span class="text-gray-600 dark:text-gray-400">🇺🇸</span> /ˈfɔːrmjələ/</div>
...
<div v-click class="p-4 bg-gradient-to-r from-lime-50 to-green-100 dark:from-lime-900 dark:to-green-800 rounded-xl mb-6 border-l-4 border-lime-500">
  ...
  <div class="text-base">
    ...
    <span v-mark.underline.orange="1" class="text-gray-800 dark:text-gray-200">处方；配方；处方药；准则；公式</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-lime-50 dark:bg-lime-900 rounded-lg">
  <div class="text-sm font-bold mb-3">🔊 发音</div>
  <div class="mb-2">
    <button @click="speak('formula', 'en-US')" class="mr-2 px-3 py-1 bg-lime-500 hover:bg-lime-600 text-white text-sm rounded">
      🇺🇸 美式
    </button>
    <span class="text-xs text-gray-500">/ˈfɔːrmjələ/</span>
  </div>
  <div>
    <button @click="speak('formula', 'en-GB')" class="mr-2 px-3 py-1 bg-lime-500 hover:bg-lime-600 text-white text-sm rounded">
      🇬🇧 英式
    </button>
...
<div class="text-2xl text-indigo-400">
  n. 衡量标准
</div>
...
<div v-click class="p-4 bg-gradient-to-r from-indigo-50 to-blue-100 dark:from-indigo-900 dark:to-blue-800 rounded-xl mb-6 border-l-4 border-indigo-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.yellow="1" class="text-gray-800 dark:text-gray-200">衡量标准；评判尺度；准绳；码尺</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-indigo-50 dark:bg-indigo-900 rounded-lg">
  <div class="text-sm font-bold mb-3">🔊 发音</div>
  <div class="mb-2">
    <button @click="speak('yardstick', 'en-US')" class="mr-2 px-3 py-1 bg-indigo-500 hover:bg-indigo-600 text-white text-sm rounded">
      🇺🇸 美式
    </button>
    <span class="text-xs text-gray-500">/ˈjɑːrdˌstɪk/</span>
  </div>
  <div>
    <button @click="speak('yardstick', 'en-GB')" class="mr-2 px-3 py-1 bg-indigo-500 hover:bg-indigo-600 text-white text-sm rounded">
      🇬🇧 英式
    </button>
...
<div class="text-2xl text-rose-400">
  n. 生物碱
</div>
...
<div v-click class="p-4 bg-gradient-to-r from-rose-50 to-pink-100 dark:from-rose-900 dark:to-pink-800 rounded-xl mb-6 border-l-4 border-rose-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.purple="1" class="text-gray-800 dark:text-gray-200">生物碱；植物碱</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-rose-50 dark:bg-rose-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˈælkəˌlɔɪd/</span></div>
  <button @click="speak('Alkaloid', 'en-US')" class="mr-2 px-3 py-1 bg-rose-500 hover:bg-rose-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('Alkaloid', 'en-GB')" class="px-3 py-1 bg-rose-500 hover:bg-rose-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
<div v-click class="p-4 bg-gradient-to-r from-emerald-50 to-teal-100 dark:from-emerald-900 dark:to-teal-800 rounded-xl mb-6 border-l-4 border-emerald-500">
  ...
  <div class="text-lg">
    ...
    <span v-mark.underline.cyan="1" class="text-gray-800 dark:text-gray-200">治疗的；医疗的；对身体好的；有益身体的</span>
  </div>
</div>
...
<div class="mt-8 p-4 bg-emerald-50 dark:bg-emerald-900 rounded-lg">
  <div class="text-sm font-bold mb-2">🔊 发音 <span class="text-gray-500 font-normal">/ˌθerəˈpjuːtɪk/</span></div>
  <button @click="speak('Therapeutic', 'en-US')" class="mr-2 px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-white text-sm rounded">
    🇺🇸 美式
  </button>
  <button @click="speak('Therapeutic', 'en-GB')" class="px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-white text-sm rounded">
    🇬🇧 英式
  </button>
</div>
</v-click>
...
<div class="text-2xl mt-8 mb-4">
  Unit 6 Passage A
  <span class="text-blue-400">English Vocabulary</span> · 学习完成
</div>
